...
import (
	"context"
	"devtools/backend/consts"
	storage2 "devtools/backend/storage"
	"devtools/backend/types"
	"devtools/backend/utils/coll"
	convutil "devtools/backend/utils/convert"
	sliceutil "devtools/backend/utils/slice"
	"encoding/json"
...
func (p *preferencesService) CheckForUpdate() (resp types.JSResp) {
	...
	res, err := http.Get("https://api.github.com/repos/mqshen/DevTools/releases/latest")
